    ...
    <html lang="ja">
      ...
      <body>
        ...
        <nav className="sticky top-0 z-50 border-b border-[var(--border)] bg-[var(--background)]/80 backdrop-blur-sm">
          <div className="mx-auto flex h-11 max-w-[860px] items-center px-6">
            ...
            <div className="flex items-center gap-2">
              <a
                href="/"
                className="rounded-md px-3 py-1.5 text-xs text-[var(--muted-foreground)] transition-colors hover:text-[var(--foreground)] hover:bg-[var(--accent)]"
              >
                一覧
              </a>
              <a
